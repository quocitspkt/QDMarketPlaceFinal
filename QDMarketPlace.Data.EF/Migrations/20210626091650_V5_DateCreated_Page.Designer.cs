...
namespace QDMarketPlace.Data.EF.Migrations
{
    ...
    [Migration("20210626091650_V5_DateCreated_Page")]
    partial class V5_DateCreated_Page
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QDMarketPlace.Data.Entities.AdvertistmentPage", b =>
                {
            ...
            modelBuilder.Entity("QDMarketPlace.Data.Entities.AdvertistmentPosition", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(20)")
                        .HasMaxLength(20);
            ...
            modelBuilder.Entity("QDMarketPlace.Data.Entities.Bill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("QDMarketPlace.Data.Entities.BillDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("QDMarketPlace.Data.Entities.Blog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("QDMarketPlace.Data.Entities.BlogTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("QDMarketPlace.Data.Entities.Color", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("QDMarketPlace.Data.Entities.Footer", b =>
                {
                    b.Property<string>("Id")
            ...
            modelBuilder.Entity("QDMarketPlace.Data.Entities.Page", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("QDMarketPlace.Data.Entities.Size", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("QDMarketPlace.Data.Entities.Slide", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("QDMarketPlace.Data.Entities.SystemConfig", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(255)")
                        .HasMaxLength(255);
            ...
            modelBuilder.Entity("QDMarketPlace.Data.Entities.AdvertistmentPosition", b =>
                {
                    b.HasOne("QDMarketPlace.Data.Entities.AdvertistmentPage", "AdvertistmentPage")
            ...
            modelBuilder.Entity("QDMarketPlace.Data.Entities.Bill", b =>
                {
                    b.HasOne("QDMarketPlace.Data.Entities.AppUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("QDMarketPlace.Data.Entities.BillDetail", b =>
                {
                    b.HasOne("QDMarketPlace.Data.Entities.Bill", "Bill")
                        .WithMany("BillDetails")
                        .HasForeignKey("BillId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("QDMarketPlace.Data.Entities.Color", "Color")
                        .WithMany()
                    ...
                    b.HasOne("QDMarketPlace.Data.Entities.Size", "Size")
                        .WithMany()
            ...
            modelBuilder.Entity("QDMarketPlace.Data.Entities.BlogTag", b =>
                {
                    b.HasOne("QDMarketPlace.Data.Entities.Blog", "Blog")
                        .WithMany("BlogTags")
            ...
            modelBuilder.Entity("QDMarketPlace.Data.Entities.Permission", b =>
                {
                    ...
                    b.HasOne("QDMarketPlace.Data.Entities.AppRole", "AppRole")
                        .WithMany()
            ...
            modelBuilder.Entity("QDMarketPlace.Data.Entities.Product", b =>
                {
                    ...
                    b.HasOne("QDMarketPlace.Data.Entities.Comment", "Comment")
                        .WithMany("Products")
